...
{
    // Result intermediate c code variable
    private String cCodeString;

    public void PrintString() {
        System . out . println (cCodeString);
    }

    public void AppendString(String s) {
        cCodeString = cCodeString.concat(s);
    }
    ...
    public void RemoveString(int len) {
        cCodeString = cCodeString.substring(0, cCodeString.length() - (len));
    }
